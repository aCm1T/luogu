...
个人在 [洛谷](https://www.luogu.com.cn/) 刷题时整理的代码仓库。

每道题对应一个 `Pxxxxx.cpp` 文件，方便本地编译、对拍和回看。
...
| ICPC WF 2014 | A–L 全题 | [`ICPC-WF-2014/`](ICPC-WF-2014/) |
| ICPC WF 2021 | A–L 全题 | [`ICPC-WF-2021/`](ICPC-WF-2021/) |
| 48th ICPC WF (2024) | A–L 全题 | [`ICPC-WF-48/`](ICPC-WF-48/) |

## 编译示例

```bash
g++ -std=c++20 -O2 -pipe P15470.cpp -o p15470
./p15470 < input.txt
```
